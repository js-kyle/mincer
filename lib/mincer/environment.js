...
var Environment = module.exports = function Environment(root) {
  ...
  // append paths
  _.forEach(Mincer.paths, _.bind(function (path) {
    this.appendPath(path);
  }, this));

  // append default engines
  _.forEach(this.getEngines(), _.bind(function (klass, ext) {
    this.addEngineToTrail(ext, klass);
  }, this));

  // register default mimeType extensions
  _.forEach(this.__mimeTypes__.types, _.bind(function (type, ext) {
