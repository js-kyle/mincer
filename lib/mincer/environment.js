...
var Environment = module.exports = function Environment(root) {
  ...
  this.__contextClass__ = function () {
  ...
  prop(this, '__engines__',           init_engines());
  prop(this, '__mimeTypes__',         init_mime_types());
  prop(this, '__preprocessors__',     init_preprocessors());
  prop(this, '__postprocessors__',    init_postprocessors());
  prop(this, '__bundle_processors__', init_bundle_processors());
