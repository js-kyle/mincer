...
getter(AssetAttributes.prototype, 'logicalPath', function () {
  ...
  // find the minimum path to the asset
  root_path = _.reduce(paths, function (root, analised_path) {
    if ((!root || analised_path.length > root.length) &&
        analised_path === pathname.substr(0, analised_path.length)) {
      return analised_path;
    }
    return root;
  }, null);
