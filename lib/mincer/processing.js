...
// internal
var Processor = require('./procesor');
...
// returns copy of pre/post-processors hash
...
module.exports.preprocessors = function (mimeType) {
  if (mimeType) {
    ...
    return deep_copy(this.__preprocessors__);
  }
};
...
module.exports.postprocessors = function (mimeType) {
  if (mimeType) {
    ...
    return deep_copy(this.__postprocessors__);
  }
};
...
module.exports.__addEngineToTrail__ = function (ext, klass) {
  var format_ext;
