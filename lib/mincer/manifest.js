 ...
 *  - `sourceMappingUrl` (false) - set `true` to embed sourcemap url
 *    into created files
...
Manifest.prototype.compile = function (files, options) {
  ...
  paths.forEach(function (logicalPath) {
    ...
    if (options.sourceMappingUrl && options.sourceMaps && asset.sourceMap) {
      if (asset.contentType === 'text/css') {
        buffer = Buffer.concat([
                          buffer,
                          new Buffer('/*# sourceMappingURL='),
                          new Buffer(path.basename(target) + '.map'),
                          new Buffer('*/')
                        ]);
      } else if (asset.contentType === 'application/javascript') {
        buffer = Buffer.concat([
                          buffer,
                          new Buffer('//# sourceMappingURL='),
                          new Buffer(path.basename(target) + '.map')
    ...
    if (options.sourceMaps && asset.sourceMap) {
