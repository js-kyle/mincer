...
Server.prototype.compile = function (pathname, callback) {
  ...
  asset.compile(function (err/*, asset */) {
    ...
    // KLUDGE:  On large assets this could cause memory bloating.
    //          Originally Sprockets are not caching StaticAssets at all.
    if ('static' === asset.type && undefined === asset.__buffer__) {
      prop(asset, '__buffer__', asset.buffer);
    }


    // Cache gzipped contents of BundledAsset/Processe
    if ('static' !== asset.type && undefined === asset.gzipped) {
