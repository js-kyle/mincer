 ...
 *
 *  `ProccessedAsset`s that are required after processing.
 *  Default to an empty `Array`.
 **/
...
Asset.prototype.writeTo = function (filename, options, callback) {
  ...
  async.series([
    ...
    function (next) { mkdirp(path.dirname(filename), next); },
 ...
 *
 *  Fires `callback(err, asset)` once asset was compiled.
 **/
