...
ProcessedAsset.prototype.compile = function (callback) {
  ...
  context.evaluate(self.pathname, options, function (err, source, extra) {
    var tasks;
    ...
    // save source map and original source if one was generated
    if (typeof extra !== 'undefined') {
      prop(self, '__originalSource__', new Buffer(extra.originalSource));
      prop(self, '__sourceMap__', new Buffer(extra.sourceMap));
    }
...
// See apidoc of [[Asset#sourceMap]]
getter(ProcessedAsset.prototype, 'sourceMap', function () {
  this._requireCompilation('sourceMap');
  return this.__sourceMap__;
});

// See apidoc of [[Asset#originalSource]]
getter(ProcessedAsset.prototype, 'originalSource', function () {
  this._requireCompilation('originalSource');
