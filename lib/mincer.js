...
Mincer.EngineTemplate     = require('./mincer/engine_template');
...
prop(Mincer, '__mimeTypes__',         new (mime.Mime)(mime_types_options));
...
mixin(Mincer, require('./mincer/engines'));
mixin(Mincer, require('./mincer/mime'));
mixin(Mincer, require('./mincer/processing'));
mixin(Mincer, require('./mincer/paths'));
