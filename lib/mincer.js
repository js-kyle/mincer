...
var ProcessorsMap = require('./mincer/processors_map');
...
prop(Mincer, '__preProcessors__',     new ProcessorsMap());
prop(Mincer, '__postProcessors__',    new ProcessorsMap());
prop(Mincer, '__bundleProcessors__',  new ProcessorsMap());
